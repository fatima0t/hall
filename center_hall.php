...
<form action="search_c.php" method="post">
    ...
    <img width="50" src="photo/detail.svg" alt="no photo">
        ...
        <table class="table" id='myTable'>
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM center WHERE `delete`=1";
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary">
                                        <a href="edit_information_c.php?updateid=<?php echo $row['id']; ?>" class="text-light">Update</a>
                                    </button>
                                    <button class="btn btn-primary">
                                        <a href="delete_c.php?removeid=<?php echo $row['id']; ?>" class="text-light">Delete</a>
                                    </button>
                                </td>
